...
import br.com.danilocerne.springboot.example.serialization.converter.YamlJackson2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer{
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		// Via QUERY PARAM. http://localhost:8080/api/person?mediaType=xml
